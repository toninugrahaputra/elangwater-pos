...
<div id="section-po-buat" class="space-y-6 hidden" data-permission="purchases.index">
...
<div id="section-po-retur" class="space-y-6 hidden" data-permission="purchases.index">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
