...
<header class="bg-white border-b border-cream-dark h-auto min-h-[64px] px-4 sm:px-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between shrink-0 z-20 py-3">
    <div class="flex items-center gap-3 flex-wrap">
        ...
        <div class="w-12 h-12 rounded-xl bg-primary flex items-center justify-center font-bold text-zinc-900 shadow-md">
    ...
    <div class="flex flex-wrap items-center gap-3 justify-end">
        ...
        <div class="relative cursor-pointer" onclick="showNotificationCenter()">
            <div class="p-2 rounded-lg hover:bg-cream-dark transition-colors">
                ...
                <span id="notif-badge" class="absolute top-0 right-0 -mt-1 -mr-1 w-5 h-5 bg-red-500 text-[9px] text-white flex items-center justify-center rounded-full font-bold">5</span>
            </div>
        </div>
        ...
        <div class="flex items-center gap-3 border-l border-cream-dark pl-4">
            ...
            <div class="w-10 h-10 rounded-full bg-primary-light flex items-center justify-center font-bold text-primary-dark text-sm border border-primary">
                RA
            </div>
        </div>
    </div>
